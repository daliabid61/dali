...
$req=$pdo ->prepare("INSERT INTO tbl_product SET name = ?,image = ?,price = ? ,quantite = ?"); 
   ...
   if(isset($_FILES['image'])){
      ...
      if(empty($errors)==true){
         move_uploaded_file($file_tmp,"../imgUploads/".$date->getTimestamp().'.'.$file_ext);
         echo "Success";
      }else{
         print_r($errors);
      }
...
$req->execute([$_POST['name'],"../imgUploads/".$date->getTimestamp().'.'.$file_ext,$_POST['price'],$_POST['quantite']]);
