            ...
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <a href="#" id="productname">' . $njanignhagna . '</a>
                    </td>
                    <td class="hidden-phone" id="productPrice">5$</td>
                    <td id="productQyantity">100</td>
                    <td id="productAlert"><span class="label label-info label-mini">Due</span></td>
                    <td id="actions">
                      <button id="editProduct" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                      <button id="deleteProduct" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button>
                    </td>
                  </tr>'
